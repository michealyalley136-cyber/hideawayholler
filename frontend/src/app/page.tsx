...
import { ArrowRight, CheckCircle2, Mail, MapPin, Mountain, ShieldCheck } from 'lucide-react';
        ...
        <div className="mx-auto w-full max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <p className="mt-5 max-w-2xl text-lg leading-8 text-stone-100 sm:text-xl">
              A resort-style cultural exchange housing community for J1 students, interns, and seasonal
              workers in the Smoky Mountain area.
            </p>
      ...
      <main>
        <section className="border-y border-amber-900/10 bg-white">
          <div className="mx-auto grid max-w-7xl gap-8 px-4 py-14 sm:px-6 lg:grid-cols-[0.8fr_1.2fr] lg:px-8">
            <div>
              ...
              <h2 className="mt-2 text-3xl font-bold text-stone-950 sm:text-4xl">Long-term housing with a community heart.</h2>
            </div>
        ...
        <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
          <div className="max-w-2xl">
            <p className="text-sm font-semibold uppercase text-emerald-800">Why Students Love It</p>
            <h2 className="mt-2 text-3xl font-bold text-stone-950 sm:text-4xl">A softer landing in the Smokies.</h2>
          </div>
          <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {loveCards.map((card) => (
              <article key={card.title} className="rounded-lg border border-stone-200 bg-white p-5 shadow-sm">
                ...
                <h3 className="mt-4 text-lg font-semibold text-stone-950">{card.title}</h3>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col justify-between gap-5 md:flex-row md:items-end">
              <div className="max-w-2xl">
                ...
                <h2 className="mt-2 text-3xl font-bold sm:text-4xl">Cabin-style spaces with distinct personalities.</h2>
              </div>
              ...
              {propertyHighlights.map((property) => (
                <article key={property.name} className="overflow-hidden rounded-lg border border-white/10 bg-white/10">
                  ...
                  <div className="p-5">
                    ...
                    <Link
                      href={`/gallery#${property.name.toLowerCase().replace(/\s+/g, '-')}`}
        ...
        <section className="mx-auto grid max-w-7xl gap-8 px-4 py-16 sm:px-6 lg:grid-cols-[1fr_1fr] lg:px-8">
          <div className="rounded-lg bg-emerald-900 p-6 text-white sm:p-8">
          ...
          <div className="rounded-lg border border-stone-200 bg-white p-6 shadow-sm sm:p-8">
            ...
            <p className="mt-3 leading-7 text-stone-600">
              A resort-style setting gives residents space to relax, gather, and enjoy the mountain area.
            </p>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col justify-between gap-5 md:flex-row md:items-end">
              <div>
                ...
                <h2 className="mt-2 text-3xl font-bold text-stone-950 sm:text-4xl">A glimpse of life at the Holler.</h2>
              </div>
              <Link
                href="/gallery"
        ...
        <section id="how-it-works" className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {howItWorks.map((step, index) => (
              <div key={step} className="rounded-lg border border-stone-200 bg-white p-5 shadow-sm">
        ...
        <section className="bg-[#f0f7f4] py-16">
          <div className="mx-auto grid max-w-7xl gap-8 px-4 sm:px-6 lg:grid-cols-[1fr_0.9fr] lg:px-8">
            <div>
              <p className="text-sm font-semibold uppercase text-emerald-900">Resident Portal Preview</p>
