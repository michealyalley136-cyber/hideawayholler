...
export function InstallAppPrompt() {
  ...
  return (
    <div className="fixed inset-x-3 bottom-3 z-[70] mx-auto max-w-md rounded-lg border border-slate-200 bg-white p-3 shadow-xl sm:hidden">
      <div className="flex items-start gap-3">
        <img src="/hideaway-logo.png" alt="Hideaway Holler" className="h-10 w-10 shrink-0 rounded-full object-cover" />
        <div className="min-w-0 flex-1">
          <p className="text-sm font-semibold text-slate-900">Install HollerHub on your phone for quick access to your resident portal.</p>
